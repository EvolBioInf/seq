...
\title{\texttt{seq} \input{version}: \emph{Description}}
\author{\input{author}}
\input{date}
...
The program \texttt{seq} was written in C on a computer running Linux.
Please contact \texttt{\input{email}} if there are any problems
with the program.
\begin{itemize}
\item Obtain the package\\
\texttt{git clone https://www.github.com/\input{repo}/seq}
...
make test
\end{verbatim}
\item The executable \texttt{seq} is located in the
